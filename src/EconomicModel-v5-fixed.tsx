...
const SCENARIO_LABELS: Record<Scenario, string> = {
  pessimistic: 'Conservative Case',
  current: 'Base Case',
  optimistic: 'Frontier Adoption',
};
...
export default function EconomicModel() {
  ...
  const coreSliders = sliderDefs.filter((s) => s.category !== 'advanced');
  const advancedSliders = sliderDefs.filter((s) => s.category === 'advanced');
        ...
        <div>
          <div className="bg-white retro-border p-6 mb-6">
            ...
            <div className="space-y-5">
              <div>
                <div className="text-[10px] font-mono uppercase tracking-[0.2em] text-deep-teal/50 mb-4">
              ...
              <div className="pt-3 border-t border-deep-teal/10">
                <button
                  onClick={() => setShowAdvanced(!showAdvanced)}
                  className="text-[10px] font-mono uppercase tracking-[0.2em] text-atomic-orange font-bold"
                >
                ...
                {showAdvanced && (
                  <div className="mt-5">
                    <div className="text-[10px] font-mono uppercase tracking-[0.2em] text-deep-teal/50 mb-4">
                      Secondary / Engineering Assumptions
                    </div>

                    <div className="space-y-5">
                      {advancedSliders.map((p) => (
                        <SliderRow key={p.id} param={{ ...p, value: params[p.id] }} onChange={handleSliderChange} />
                      ))}
                    </div>
                  </div>
        ...
        <div className="space-y-8">
          ...
          <div className="bg-white retro-border p-6">
            ...
            <div className="space-y-4">
              <div>
                <div className="text-sm font-bold text-deep-teal mb-1">
                  Current Result
                </div>
                <p className="text-sm text-deep-teal/70 leading-relaxed">
                  {breakEvenYear
                    ...
                    : 'Orbital compute does not reach cost parity within the modeled time horizon.'}
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-sm text-deep-teal/70 leading-relaxed">
                  Launch economics, AI demand growth, hardware specialization, and terrestrial energy costs exert the largest influence on outcomes.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-sm text-deep-teal/70 leading-relaxed">
                  Radiation-related hardware degradation, latency-sensitive workloads, and high upfront capital intensity remain the largest unresolved risks for orbital compute infrastructure.
                </p>
              </div>
            </div>
          </div>
